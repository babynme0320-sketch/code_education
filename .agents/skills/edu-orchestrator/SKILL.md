...
| 에이전트 | 역할 | 파일 |
|---------|------|------|
| content-writer | chapters.json 콘텐츠 작성 | `.Codex/agents/content-writer.md` |
| frontend-dev | React 컴포넌트/페이지 구현 | `.Codex/agents/frontend-dev.md` |
| backend-dev | FastAPI 엔드포인트/데이터 관리 | `.Codex/agents/backend-dev.md` |
| qa-verifier | 빌드/API/배포 검증 | `.Codex/agents/qa-verifier.md` |
